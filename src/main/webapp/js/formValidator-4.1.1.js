...
$.formValidator = 
{
	...
	initConfig : function(controlOptions)
	{
		...
		/*$.ajax({async:false,cache: true,type: "GET",url: themedir + "themes/"+settings.theme+"/js/theme.js",dataType: "script",
	...
	return this.each(function(e)
	{
		...
		{			
			...
			{		
				...
				var offset = $("#"+relativeID ).offset();
				setting_temp.tipCss.top = offset.top + setting_temp.tipCss.top+4;
